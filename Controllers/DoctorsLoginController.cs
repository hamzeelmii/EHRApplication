...
namespace EHRApplication.Controllers
{
    public class DoctorsLoginController : Controller
    {
        ...
        public DoctorsLoginController(EHRApplicationContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DoctorID,FirstName,LastName,LoginID")] Doctor doctor)
        {
